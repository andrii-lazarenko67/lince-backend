...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const userMap = {};
    users.forEach(user => {
      if (user.email === 'manager@lince.com') userMap.charles = user.id;
    ...
    const notifications = [
      ...
      },
      {
        ...
        message: 'pH of Main Pool measured at 7.9, above maximum limit of 7.8.',
        priority: 'high',
        referenceType: 'System',
        referenceId: systemMap.pool,
        createdById: null,
      ...
      },
      {
        ...
        message: 'Don\'t forget to record the daily data for the Main Pool.',
        priority: 'low',
        referenceType: 'System',
        referenceId: systemMap.pool,
        createdById: null,
