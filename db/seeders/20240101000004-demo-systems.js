...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('MonitoringPoints', [
      ...
      { systemId: 1, name: 'pH da Água', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 7.2, maxValue: 7.8, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 1, name: 'Cloro Residual Livre', parameterId: paramMap['Cloro'], unitId: unitMap['mg/L'], minValue: 1.0, maxValue: 3.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 1, name: 'Temperatura', parameterId: paramMap['Temperatura'], unitId: unitMap['°C'], minValue: 24, maxValue: 30, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 1, name: 'Turbidez', parameterId: paramMap['Turbidez'], unitId: unitMap['NTU'], minValue: 0, maxValue: 0.5, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 1, name: 'Alcalinidade Total', parameterId: paramMap['Alcalinidade'], unitId: unitMap['mg/L'], minValue: 80, maxValue: 120, alertEnabled: false, createdAt: new Date(), updatedAt: new Date() },

      // Piscina Infantil (System 2)
      { systemId: 2, name: 'pH da Água', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 7.2, maxValue: 7.8, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 2, name: 'Cloro Residual Livre', parameterId: paramMap['Cloro'], unitId: unitMap['mg/L'], minValue: 1.0, maxValue: 3.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 2, name: 'Temperatura', parameterId: paramMap['Temperatura'], unitId: unitMap['°C'], minValue: 26, maxValue: 32, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },

      // Torre de Resfriamento 1 (System 3)
      { systemId: 3, name: 'pH', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 7.0, maxValue: 9.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 3, name: 'Condutividade', parameterId: paramMap['Condutividade'], unitId: unitMap['µS/cm'], minValue: 0, maxValue: 2500, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 3, name: 'Temperatura Entrada', parameterId: paramMap['Temperatura'], unitId: unitMap['°C'], minValue: 20, maxValue: 45, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 3, name: 'Temperatura Saída', parameterId: paramMap['Temperatura'], unitId: unitMap['°C'], minValue: 15, maxValue: 35, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 3, name: 'Cloro Total', parameterId: paramMap['Cloro'], unitId: unitMap['mg/L'], minValue: 0.5, maxValue: 1.5, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 3, name: 'Ciclos de Concentração', parameterId: paramMap['Ciclos'], unitId: unitMap[''], minValue: 3, maxValue: 6, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },

      // Torre de Resfriamento 2 (System 4)
      { systemId: 4, name: 'pH', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 7.0, maxValue: 9.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 4, name: 'Condutividade', parameterId: paramMap['Condutividade'], unitId: unitMap['µS/cm'], minValue: 0, maxValue: 2500, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 4, name: 'Temperatura Entrada', parameterId: paramMap['Temperatura'], unitId: unitMap['°C'], minValue: 20, maxValue: 45, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 4, name: 'Cloro Total', parameterId: paramMap['Cloro'], unitId: unitMap['mg/L'], minValue: 0.5, maxValue: 1.5, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },

      // Caldeira (System 5)
      { systemId: 5, name: 'pH da Água de Alimentação', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 8.5, maxValue: 9.5, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 5, name: 'Condutividade', parameterId: paramMap['Condutividade'], unitId: unitMap['µS/cm'], minValue: 0, maxValue: 3500, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 5, name: 'Dureza Total', parameterId: paramMap['Dureza'], unitId: unitMap['mg/L CaCO3'], minValue: 0, maxValue: 5, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 5, name: 'Sílica', parameterId: paramMap['Sílica'], unitId: unitMap['mg/L'], minValue: 0, maxValue: 150, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 5, name: 'Oxigênio Dissolvido', parameterId: paramMap['OD'], unitId: unitMap['mg/L'], minValue: 0, maxValue: 0.007, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 5, name: 'Ferro Total', parameterId: paramMap['Ferro'], unitId: unitMap['mg/L'], minValue: 0, maxValue: 0.1, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 5, name: 'Alcalinidade', parameterId: paramMap['Alcalinidade'], unitId: unitMap['mg/L'], minValue: 200, maxValue: 700, alertEnabled: false, createdAt: new Date(), updatedAt: new Date() },

      // ETA (System 6)
      { systemId: 6, name: 'pH Entrada', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 6.0, maxValue: 9.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 6, name: 'pH Saída', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 6.5, maxValue: 8.5, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 6, name: 'Turbidez Entrada', parameterId: paramMap['Turbidez'], unitId: unitMap['NTU'], minValue: 0, maxValue: 100, alertEnabled: false, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 6, name: 'Turbidez Saída', parameterId: paramMap['Turbidez'], unitId: unitMap['NTU'], minValue: 0, maxValue: 1.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 6, name: 'Cloro Residual', parameterId: paramMap['Cloro'], unitId: unitMap['mg/L'], minValue: 0.5, maxValue: 2.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 6, name: 'Cor Aparente', parameterId: paramMap['Cor'], unitId: unitMap['uH'], minValue: 0, maxValue: 15, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },

      // ETE (System 7)
      { systemId: 7, name: 'pH Entrada', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 5.0, maxValue: 9.0, alertEnabled: false, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 7, name: 'pH Saída', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 5.0, maxValue: 9.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 7, name: 'DBO Entrada', parameterId: paramMap['DBO'], unitId: unitMap['mg/L'], minValue: 0, maxValue: 500, alertEnabled: false, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 7, name: 'DBO Saída', parameterId: paramMap['DBO'], unitId: unitMap['mg/L'], minValue: 0, maxValue: 60, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 7, name: 'DQO Saída', parameterId: paramMap['DQO'], unitId: unitMap['mg/L'], minValue: 0, maxValue: 150, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 7, name: 'Sólidos Sedimentáveis', parameterId: paramMap['SS'], unitId: unitMap['mL/L'], minValue: 0, maxValue: 1.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 7, name: 'Oxigênio Dissolvido', parameterId: paramMap['OD'], unitId: unitMap['mg/L'], minValue: 2.0, maxValue: 8.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },

      // Efluentes Linha 1 (System 8)
      { systemId: 8, name: 'pH', parameterId: paramMap['pH'], unitId: unitMap[''], minValue: 6.0, maxValue: 9.0, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 8, name: 'Temperatura', parameterId: paramMap['Temperatura'], unitId: unitMap['°C'], minValue: 15, maxValue: 40, alertEnabled: true, createdAt: new Date(), updatedAt: new Date() },
      { systemId: 8, name: 'Vazão', parameterId: paramMap['Vazão'], unitId: unitMap['m³/h'], minValue: 0, maxValue: 50, alertEnabled: false, createdAt: new Date(), updatedAt: new Date() }
    ], {});
